...
Mas atenção, todas as atividades do {{< var tipo.observe >}} precisam ser pré-agendadas ou estarem programadas no [calendário de eventos]({{< var loc.calendario >}}\calendario.qmd). Não há pessoas disponíveis para atendimento fora dessas condições.
