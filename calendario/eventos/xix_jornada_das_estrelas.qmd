---
title: XIX Jornada das Estrelas
date: 14 02 25
category: "Próximo" 
format:
    html:
...
Entre os dias 18/03/25 e 20/03/25 ocorrerá a XIX edição do evento [Jornada das Estrelas](/atividades/jornada_das_estrelas/jornada_das_estrelas.qmd).

_Esta é a primeira vez que a Jornada das Estrelas ocorrerá à tarde e à noite!_
...
<script defer>
    ...
    const agendamentos = [
        // {escola:'', professor:'', dia:'', horario:'', escolaridade:'', alunos: ''},
    ];
