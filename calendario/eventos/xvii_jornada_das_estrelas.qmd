...
<script defer>
    ...
    const agendamentos = [
        {escola:'INSA', professor:'Cintia Dezotti', dia:dias[0], horario: horarios[0], escolaridade: escolaridade.options[1], alunos: alunos.options[3]},
        {escola:'INSA', professor:'Rodolfo Milares', dia:dias[0], horario: horarios[0], escolaridade: escolaridade.options[1], alunos: alunos.options[3]},
        {escola:'INSA', professor:'Karine Diena', dia:dias[0], horario: horarios[0], escolaridade: escolaridade.options[1], alunos: alunos.options[3]},
    ];
