...
```{=html}
<div id="carrossel" class="carousel">
  <img id="carrossel-img" src="" alt="Imagem do carrossel">
  <p id="carrossel-legenda"></p>
...
const legendas = [
  legendas = [
    "Lua vista de um dos binóculos em exposição",
    "Atividade dos óculos VR",
    "Atividade de oculus VR",
    "Família na modelagem das estações do ano",
    "Criança vendo o Sol através do Telescópio com filtro protetor ocular",
    "Aluna vendo o Sol pelo Telescópio",
    "Escola na fila para a visualização do Sol pelo Telescópio",
    "Fundamental I no Observatório a Olho Nu",
    "Explicação do Relógio Solar",
    "Família na modelagem das estações do ano",
    "Casal vendo a Lua pelo Binóculos",
    "Alunos do EJA no Observatório",
    "Eja na modelagem das estações do ano",
    "Famílias no Observatório",
    "Mulher visualizando o céu pelo binóculos",
    "Observatório no período noturno",
    "Observatório no período diurno",
    "Público para visualização dos telescópios",
    "Escola visitante no passeio dos planetas",
    "Jogo Astronocartas",
    "Escola visitante no Observatório",
    "Escola visitante no telescópio voltado pro Sol",
    "Observatório com escola visitante",
    "Escola visitante no Observatório noturno",
    "Escola visitante na modelagem das estações do ano",
    "Escola visitante no passeio dos planetas",
    "Passeio dos planetas visto a partir do Sol",
    "Passeio dos planetas com escola visitante",
    "Modelagem das estações do ano",
    "Modelagem das estações do ano",
    "Família visitante no Observatório",
    "Escola visitante na bússola do Observatório",
    "Relógio estelar",
    "Observatório a olho nu durante a noite",
    "Escolas no observatório",
    "Equinócio de Outono visto do Observatório a olho nu"
];

let indice = 0;
const img = document.getElementById("carrossel-img");
const leg = document.getElementById("carrossel-legenda");

function atualizar() {
  img.src = imagens[indice];
  leg.textContent = legendas[indice];
}
...
// atualiza uma vez na carga e depois a cada 3s
atualizar();
